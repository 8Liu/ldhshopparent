...
import com.liudehuang.unionpay.acp.sdk.AcpService;
import com.liudehuang.unionpay.acp.sdk.LogUtil;
import com.liudehuang.unionpay.acp.sdk.SDKConfig;
import com.liudehuang.unionpay.acp.sdk.UnionPayBase;
...
public class UnionPayStrategy implements PayStrategy {
    ...
    public String toPayHtml(PaymentChannelEntity paymentChannel, PayMentTransacDTO payMentTransacDTO) {
        ...
        requestData.put("encoding", UnionPayBase.encoding);
        // 签名方法
        ...
        // 渠道类型，这个字段区分B2C网关支付和手机wap支付；07：PC,平板
        // 08：手机
        ...
        requestData.put("payTimeout",
                new SimpleDateFormat("yyyyMMddHHmmss").format(System.currentTimeMillis() + 15 * 60 * 1000));
//////////////////////////////////////////////////
        //
